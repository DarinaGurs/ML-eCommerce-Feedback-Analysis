...
![График кластеризации квартир](top10.png)

#### Визуализации:

Столбчатая диаграмма с наиболее часто встречающимися словами:

![График кластеризации квартир](word_number.png)

Визуализация wordcloud:

![График кластеризации квартир](wordcloud.png)
